...
export const SHOT_SPEED_MULTIPLIER = 1.75
export const SHOT_SPEED = SPEED * SHOT_SPEED_MULTIPLIER
...
export const COMBO_X4_AT = 10
export const MULTISHOT_SPREAD_RAD = 0.068
export const FEVER_SCORE_MULTIPLIER = 2
export const FEVER_SHOTS = 3

export function shotCountForCombo(combo: number, fever = false): 1 | 2 | 3 | 4 {
  if (combo >= COMBO_X4_AT) return 4
  if (combo >= COMBO_X3_AT || fever) return 3
