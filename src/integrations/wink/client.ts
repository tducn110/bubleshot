...
export class WinkGameIntegration {
  ...
  constructor() {
    this.readyPromise = getWinkInitPromise()
      .then(() => undefined)
      .catch(() => undefined)
  }
  ...
  startRound(): WinkRound {
    if (
      typeof window !== "undefined" &&
      (window as any).Wink &&
      typeof (window as any).Wink.gameplayStart === "function"
    ) {
      try {
        ;(window as any).Wink.gameplayStart()
      } catch {}
    }
  ...
  track(eventName: string, properties?: Record<string, unknown>): void {
    if (
      typeof window !== "undefined" &&
      (window as any).Wink &&
      typeof (window as any).Wink.track === "function"
    ) {
  ...
  async submitFinalScore(
    ...
    if (
      typeof window === "undefined" ||
      !(window as any).Wink ||
      typeof (window as any).Wink.submitScore !== "function"
    ) {
  ...
  async getPersonalBest(): Promise<LeaderboardEntry | null> {
    if (
      typeof window === "undefined" ||
      !(window as any).Wink ||
      typeof (window as any).Wink.getPersonalBest !== "function"
    ) {
      return null
    }
  ...
  async refreshLeaderboard(options?: {
    ...
    if (
      typeof window === "undefined" ||
      !(window as any).Wink ||
      typeof (window as any).Wink.getLeaderboard !== "function"
    ) {
  ...
  get capabilities(): WinkBridgeCapabilities {
    if (
      typeof window !== "undefined" &&
      (window as any).Wink &&
      typeof (window as any).Wink.can === "function"
    ) {
      return {
  ...
  bindLifecycle(handlers: WinkLifecycleHandlers): () => void {
    ...
    if (
      typeof window !== "undefined" &&
      (window as any).Wink &&
      typeof (window as any).Wink.on === "function"
    ) {
      if (handlers.onPause)
        stops.push((window as any).Wink.on("pause", handlers.onPause))
      if (handlers.onResume)
        stops.push((window as any).Wink.on("resume", handlers.onResume))
      if (handlers.onMute)
        stops.push((window as any).Wink.on("mute", handlers.onMute))
      if (handlers.onUnmute)
        stops.push((window as any).Wink.on("unmute", handlers.onUnmute))
    }
